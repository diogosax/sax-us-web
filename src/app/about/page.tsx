  ...
  return (
    <>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-[#0A2342] mb-6">About SAX Group</h2>
      ...
      <section className="bg-[#F8FAFC] py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex gap-4 items-start">
            <div className="w-1 shrink-0 rounded-full bg-[#00BFA6] self-stretch" />
            <div>
      ...
      <section className="bg-white py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="flex gap-4 items-start">
            <div className="w-1 shrink-0 rounded-full bg-[#0A2342] self-stretch" />
            <div>
              <h2 className="text-2xl font-bold text-[#0A2342] mb-4">Our Vision</h2>
              <p className="text-lg text-[#475569] leading-relaxed">
      ...
      <section className="bg-[#F8FAFC] py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-[#0A2342] mb-4">Our Values</h2>
      ...
      <section className="bg-[#0A2342] py-20 px-6 text-white text-center">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-bold mb-5">Work With Us</h2>
